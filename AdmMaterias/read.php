...
// Registrar actividad de entrada a "Administrar Materias"
$modulo = "Gestión de Materias";
$descripcion = "Entrada a la sección de administración de materias";
$estado = "Acceso";
registrar_actividad($idU, $modulo, $descripcion, $estado, $conn);

// Obtener lista de materias
$sql = "SELECT id_materia, nombre_materia, clave_materia, creditos FROM Materias";
